...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 `src/pages/watch/WatchVerbPage.tsx` created with 7 sections, all meanings, all using default.png
- [ ] #2 WATCH_PARTICLES constant added to PhrasalVerbsListPage.tsx with all 7 particles
- [ ] #3 VERBS entry added for Watch after Warm in PhrasalVerbsListPage.tsx
- [ ] #4 Route `/phrasal-verbs/list/watch` registered in src/main.tsx
- [ ] #5 watchSections added to listVerbIndex.ts search index
- [ ] #6 7 test files created under src/__tests__/watch_verb_page/ (one per particle)
- [ ] #7 PhrasalVerbsListPage.test.tsx extended with Watch card, subtitle, and copy-button describe blocks
