...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 #1 `src/pages/lay/LayVerbPage.tsx` created with 13 sections, all meanings, all using default.png
- [ ] #2 #2 LAY_PARTICLES constant added to PhrasalVerbsListPage.tsx with all 13 particles
- [ ] #3 #3 VERBS entry added for Lay in alphabetical position in PhrasalVerbsListPage.tsx
- [ ] #4 #4 Route `/phrasal-verbs/list/lay` registered in src/main.tsx
- [ ] #5 #5 laySections added to listVerbIndex.ts search index
- [ ] #6 #6 13 test files created under src/__tests__/lay_verb_page/ (one per particle)
- [ ] #7 #7 PhrasalVerbsListPage.test.tsx extended with Lay card, subtitle, and copy-button describe blocks
