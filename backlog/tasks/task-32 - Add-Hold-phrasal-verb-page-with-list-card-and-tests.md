...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 #1 `src/pages/hold/HoldVerbPage.tsx` created with 12 sections, all meanings, all using default.png
- [x] #2 #2 HOLD_PARTICLES constant added to PhrasalVerbsListPage.tsx with all 12 particles
- [x] #3 #3 VERBS entry added for Hold in alphabetical position in PhrasalVerbsListPage.tsx
- [x] #4 #4 Route `/phrasal-verbs/list/hold` registered in src/main.tsx
- [x] #5 #5 holdSections added to listVerbIndex.ts search index
- [x] #6 #6 12 test files created under src/__tests__/hold_verb_page/ (one per particle)
- [x] #7 #7 PhrasalVerbsListPage.test.tsx extended with Hold card, subtitle, and copy-button describe blocks
