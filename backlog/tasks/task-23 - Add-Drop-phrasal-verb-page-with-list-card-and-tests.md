...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 #1 `src/pages/drop/DropVerbPage.tsx` created with 15 sections, all meanings, all using default.png
- [ ] #2 #2 DROP_PARTICLES constant added to PhrasalVerbsListPage.tsx with all 15 particles
- [ ] #3 #3 VERBS entry added for Drop after Dress in PhrasalVerbsListPage.tsx
- [ ] #4 #4 Route `/phrasal-verbs/list/drop` registered in src/main.tsx
- [ ] #5 #5 dropSections added to listVerbIndex.ts search index
- [ ] #6 #6 15 test files created under src/__tests__/drop_verb_page/ (one per particle)
- [ ] #7 #7 PhrasalVerbsListPage.test.tsx extended with Drop card, subtitle, and copy-button describe blocks
