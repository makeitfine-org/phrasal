...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 `src/pages/throw/ThrowVerbPage.tsx` created with 12 sections, all meanings, all using default.png
- [ ] #2 THROW_PARTICLES constant added to PhrasalVerbsListPage.tsx with all 12 particles
- [ ] #3 VERBS entry added for Throw after Think in PhrasalVerbsListPage.tsx
- [ ] #4 Route `/phrasal-verbs/list/throw` registered in src/main.tsx
- [ ] #5 throwSections added to listVerbIndex.ts search index
- [ ] #6 12 test files created under src/__tests__/throw_verb_page/ (one per particle)
- [ ] #7 PhrasalVerbsListPage.test.tsx extended with Throw card, subtitle, and copy-button describe blocks
