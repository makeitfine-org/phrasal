...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 #1 `src/pages/run/RunVerbPage.tsx` created with 23 sections, all meanings, all using default.png
- [ ] #2 #2 RUN_PARTICLES constant added to PhrasalVerbsListPage.tsx with all 23 particles
- [ ] #3 #3 VERBS entry added for Run after Pull in PhrasalVerbsListPage.tsx
- [ ] #4 #4 Route `/phrasal-verbs/list/run` registered in src/main.tsx
- [ ] #5 #5 runSections added to listVerbIndex.ts search index
- [ ] #6 #6 23 test files created under src/__tests__/run_verb_page/ (one per particle)
- [ ] #7 #7 PhrasalVerbsListPage.test.tsx extended with Run card, subtitle, and copy-button describe blocks
