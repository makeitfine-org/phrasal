...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 #1 `src/pages/figure/FigureVerbPage.tsx` created with 6 sections, all meanings, all using default.png
- [ ] #2 #2 FIGURE_PARTICLES constant added to PhrasalVerbsListPage.tsx with all 6 particles
- [ ] #3 #3 VERBS entry added for Figure in alphabetical position in PhrasalVerbsListPage.tsx
- [ ] #4 #4 Route `/phrasal-verbs/list/figure` registered in src/main.tsx
- [ ] #5 #5 figureSections added to listVerbIndex.ts search index
- [ ] #6 #6 6 test files created under src/__tests__/figure_verb_page/ (one per particle)
- [ ] #7 #7 PhrasalVerbsListPage.test.tsx extended with Figure card, subtitle, and copy-button describe blocks
