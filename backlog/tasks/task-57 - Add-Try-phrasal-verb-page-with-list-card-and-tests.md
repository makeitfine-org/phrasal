...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 `src/pages/try/TryVerbPage.tsx` created with 6 sections, all meanings, all using default.png
- [ ] #2 TRY_PARTICLES constant added to PhrasalVerbsListPage.tsx with all 6 particles
- [ ] #3 VERBS entry added for Try after Throw in PhrasalVerbsListPage.tsx
- [ ] #4 Route `/phrasal-verbs/list/try` registered in src/main.tsx
- [ ] #5 trySections added to listVerbIndex.ts search index
- [ ] #6 6 test files created under src/__tests__/try_verb_page/ (one per particle)
- [ ] #7 PhrasalVerbsListPage.test.tsx extended with Try card, subtitle, and copy-button describe blocks
