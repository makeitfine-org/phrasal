...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 `src/pages/stick/StickVerbPage.tsx` created with 11 sections, all meanings, all using default.png
- [x] #2 STICK_PARTICLES constant added to PhrasalVerbsListPage.tsx with all 11 particles
- [x] #3 VERBS entry added for Stick after Stand in PhrasalVerbsListPage.tsx
- [x] #4 Route `/phrasal-verbs/list/stick` registered in src/main.tsx
- [x] #5 stickSections added to listVerbIndex.ts search index
- [x] #6 11 test files created under src/__tests__/stick_verb_page/ (one per particle)
- [x] #7 PhrasalVerbsListPage.test.tsx extended with Stick card, subtitle, and copy-button describe blocks
