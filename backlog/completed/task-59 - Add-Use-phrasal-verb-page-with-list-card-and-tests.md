...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 `src/pages/use/UseVerbPage.tsx` created with 3 sections, all meanings, all using default.png
- [x] #2 USE_PARTICLES constant added to PhrasalVerbsListPage.tsx with all 3 particles
- [x] #3 VERBS entry added for Use after Turn in PhrasalVerbsListPage.tsx
- [x] #4 Route `/phrasal-verbs/list/use` registered in src/main.tsx
- [x] #5 useSections added to listVerbIndex.ts search index
- [x] #6 3 test files created under src/__tests__/use_verb_page/ (one per particle)
- [x] #7 PhrasalVerbsListPage.test.tsx extended with Use card, subtitle, and copy-button describe blocks
