...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 #1 `src/pages/point/PointVerbPage.tsx` created with 6 sections, all meanings, all using default.png
- [x] #2 #2 POINT_PARTICLES constant added to PhrasalVerbsListPage.tsx with all 6 particles
- [x] #3 #3 VERBS entry added for Point after Pick in PhrasalVerbsListPage.tsx
- [x] #4 #4 Route `/phrasal-verbs/list/point` registered in src/main.tsx
- [x] #5 #5 pointSections added to listVerbIndex.ts search index
- [x] #6 #6 6 test files created under src/__tests__/point_verb_page/ (one per particle)
- [x] #7 #7 PhrasalVerbsListPage.test.tsx extended with Point card, subtitle, and copy-button describe blocks
