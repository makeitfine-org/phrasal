...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 `src/pages/warm/WarmVerbPage.tsx` created with 5 sections, all meanings, all using default.png
- [x] #2 WARM_PARTICLES constant added to PhrasalVerbsListPage.tsx with all 5 particles
- [x] #3 VERBS entry added for Warm after Wake in PhrasalVerbsListPage.tsx
- [x] #4 Route `/phrasal-verbs/list/warm` registered in src/main.tsx
- [x] #5 warmSections added to listVerbIndex.ts search index
- [x] #6 5 test files created under src/__tests__/warm_verb_page/ (one per particle)
- [x] #7 PhrasalVerbsListPage.test.tsx extended with Warm card, subtitle, and copy-button describe blocks
