...
complete -F _redeploy_vps ./vps/arch/bash/deployment/mini/redeploy-vps.sh

complete -F _undeploy_vps undeploy-vps.sh
complete -F _undeploy_vps ./vps/arch/bash/deployment/mini/special/3.undeploy-vps.sh

complete -F _undeploy_vps deploy-first-or-after-undeploy-vps.sh
complete -F _undeploy_vps ./vps/arch/bash/deployment/mini/special/2.deploy-first-or-after-undeploy-vps.sh
